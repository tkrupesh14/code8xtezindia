...
if (isset($_POST['resetBtn'])) {
    ...
    $sql = " SELECT * FROM team_members WHERE email = '$email' LIMIT 1";
    ...
    if (!mysqli_num_rows($run) > 0) {
        ...
        $get_email = $row['email'];
        $update_token = "UPDATE team_members SET token = '$token' WHERE email = '$get_email' LIMIT 1";
...
<head>
    ...
    <title>Team Login - CE Tasks</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST">
                                        ...
                                        <input type="submit" name="resetBtn" id="" value="Send Varification Mail" class="btn btn-primary btn-user btn-block">
                                        <hr>
