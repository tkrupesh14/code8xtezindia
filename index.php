...
?>
        ...
        <div class="row services-wrapper">
          ...
          <div class="col-md-6 col-lg-4 col-xs-12 padding-none">
            <div class="services-item wow fadeInDown" data-wow-delay="0.8s">
              ...
              <div class="services-content">
                <h3><a href="#">Learn and build on TEZOS</a></h3>
                <p>Lorem ipsum dolor sit amet, consectetuer commodo ligula eget dolor.</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 col-xs-12 padding-none">
            <div class="services-item wow fadeInDown" data-wow-delay="1s">
              ...
              <div class="services-content">
                <h3><a href="#">Goodies & Internship Oppertunites</a></h3>
                <p>Lorem ipsum dolor sit amet, consectetuer commodo ligula eget dolor.</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 col-xs-12 padding-none">
            <div class="services-item wow fadeInDown" data-wow-delay="1.2s">
              ...
              <div class="services-content">
                <h3><a href="#">Internship and pre-placement opportunities.</a></h3>
                <p>Lorem ipsum dolor sit amet, consectetuer commodo ligula eget dolor.</p>
              </div>
            </div>
          </div>
    ...
    <section id="about" class="section-padding">
      <div class="container">
       ...
       <div class="row">
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus natus veniam doloremque quas quaerat perferendis, quidem ipsum nihil, expedita, eveniet nobis. Nostrum nesciunt delectus cumque nemo, dolorum eveniet similique qui quibusdam sint necessitatibus possimus harum autem optio veritatis officia eligendi. <br> <br>
        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Odio ex repudiandae saepe commodi reprehenderit minima, voluptatem rerum illum eum perspiciatis quaerat assumenda itaque dignissimos debitis earum quam cumque ullam modi mollitia laboriosam sapiente pariatur qui dolore facere. Animi assumenda quidem quae quibusdam numquam harum laboriosam accusantium non! Esse aperiam maxime mollitia eum adipisci. Neque ipsam maiores, totam error enim quasi temporibus labore eaque ratione repudiandae tempore consectetur dicta aliquid incidunt quibusdam autem beatae illo mollitia quisquam ut. Velit, enim eum dolore, exercitationem dolorem commodi saepe ipsa magnam illum, nemo vel necessitatibus neque dolores? Quaerat voluptate aspernatur earum sequi doloremque illo?
      </p>
       </div>
      </div>
    </section>
        ...
        <div class="row">
          <div class="col-sm-6 col-md-6 col-lg-4">
            ...
            <div class="team-item wow fadeInUp" data-wow-delay="0.2s">
              <div class="team-img">
                <img class="img-fluid" src="https://tezosindia.codeate.in/assets/img/speakers/speaker1.jpeg" alt="">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-6 col-md-6 col-lg-4">
            ...
            <div class="team-item wow fadeInUp" data-wow-delay="0.2s">
              <div class="team-img">
                <img class="img-fluid" src="https://tezosindia.codeate.in/assets/img/Mentors/sanket.jpeg" alt="">
                <div class="team-overlay">
                  <div class="overlay-social-icon text-center">
                    <ul class="social-icons">
                      <li><a href="#"><i class="lni-facebook-filled" aria-hidden="true"></i></a></li>
              ...
              <div class="info-text">
                <h3><a href="#">Sanket Nighot</a></h3>
                <p>Co-Founder, Game Geeks</p>
              </div>
            </div>
            <!-- Team Item Ends -->
          </div>
          <div class="col-sm-6 col-md-6 col-lg-4">
            ...
            <div class="team-item wow fadeInUp" data-wow-delay="0.2s">
              <div class="team-img">
                <img class="img-fluid" src="https://tezosindia.codeate.in/assets/img/Mentors/thakur.jpeg" alt="">
                <div class="team-overlay">
                  <div class="overlay-social-icon text-center">
                    <ul class="social-icons">
                      <li><a href="#"><i class="lni-facebook-filled" aria-hidden="true"></i></a></li>
              ...
              <div class="info-text">
                <h3><a href="#">Thakur Patel</a></h3>
                <p>Workshop Instructor, Tezos India</p>
              </div>
            </div>
            <!-- Team Item Ends -->
          </div>
        ...
        <div class="row mb-30 text-center wow fadeInDown" data-wow-delay="0.3s">
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="spnsors-logo">
              <a href="#"><img class="img-fluid" src="https://tezosindia.codeate.in/assets/img/community/2.png" alt=""></a>
            </div>
          </div>
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="spnsors-logo">
              <a href="#"><img class="img-fluid" src="https://tezosindia.codeate.in/assets/img/community/3.png" alt=""></a>
            </div>
          </div>
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="spnsors-logo">
              <a href="#"><img class="img-fluid" src="https://tezosindia.codeate.in/assets/img/community/4.png" alt=""></a>
            </div>
          </div>
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="spnsors-logo">
              <a href="#"><img class="img-fluid" src="https://tezosindia.codeate.in/assets/img/community/5.png" alt=""></a>
            </div>
          </div>
